...
var TransactionRow = React.createClass({displayName: "TransactionRow",
    ...
    render: function (){
        ...
        return (
            React.createElement("tr", null, 
            React.createElement("td", null, trans.date), 
            React.createElement("td", null, trans.name), 
            React.createElement("td", null, trans.amount), 
            React.createElement("td", null, trans.account), 
            React.createElement("td", null, trans.category), 
            React.createElement("td", null, React.createElement("i", {onClick: this.DeleteTransaction, className: "fa fa-trash-o"}))
            )
        )
    }
});
